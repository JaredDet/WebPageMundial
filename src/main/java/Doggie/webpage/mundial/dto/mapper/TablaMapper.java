...
public interface TablaMapper {
    ...
    default TablaEquipo from(Equipo equipo) {
        ...
        var resultados = new DatosResultadosMapperImpl().from(equipo);

        return new TablaEquipo(equipo.getNombre(), equipo.codigo(), jugados, ganados,
                perdidos, empatados, golesAFavor, golesEnContra, diferenciaGoles, puntos, resultados);
    }
