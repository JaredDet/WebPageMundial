...
import Doggie.WebPage.Mundial.modelo.repositorio.RepositorioAbreviatura;
...
public class JugadorMapper {
    ...
    private final RepositorioAbreviatura repositorioAbreviatura;
    ...
    private Convocado crearConvocadoDesdePeticion(JugadorPeticion jugadorPeticion) {
        ...
        var abreviatura = repositorioAbreviatura.findByNombre(jugadorPeticion.getPosicion());
        var posicion = repositorioPosicion.findByAbreviaturaYLado(abreviatura.getAbreviaturaId(), jugadorPeticion.getLado());
