...
public class ControladorPartido {
    ...
    @GetMapping("/{partidoId}/datosExtras")
    public DatosExtrasPartido datosExtras(@PathVariable Long partidoId) {
        return servicioPartido.findDatosExtrasByPartido(partidoId);
    }
